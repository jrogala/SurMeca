...
Figure(\ref{detect}) presents the percent of detection of a damage between sensors 6 and 7 against the damage percent (a single damage is always simulated between sensors 6 and 7). We can see here that below 5\% of damage, none of the methods detect the damage more than 50\% of the time, but we can see that BL is the best: at 10\% of damage, it reach 90\% of detection, while the others are below 30\%. However, at 15\% of damage, it's BD and G which are the best, with 100\% of detection. BL reaches 100\% of detection at 20\% of damage, and R reaches it at 30\% of damage. Here, R seems to be the worst.
