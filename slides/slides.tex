\documentclass{beamer}
  ...
  \date{Supervised by Michael Döhler}
  \institute{\textit{École Normale Supérieure de Rennes, département Informatique et Télécommunications}}
...
\begin{center}
\begin{itemize}
\item<1-> {\only<5-6>{\color{green}}Detection: Is the structure damaged or not?}
\vspace{1\baselineskip}
\item<2-|alert@6> Localization: Where is the damaged area located?
\vspace{1\baselineskip}
