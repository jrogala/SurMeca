...
def experience():
	...
	parser.writeValues3("data/threshold2_noise.txt",threshold_gauss)
	parser.writeValues3("data/threshold1_inv_noise.txt",threshold_inv)
	parser.writeValues3("data/threshold2_inv_noise.txt",threshold_gauss_inv)
