...
def experience():
	...
	parser.writeValues3("data/threshold1.txt",threshold)
	parser.writeValues3("data/threshold2.txt",threshold_gauss)
	parser.writeValues3("data/threshold1_inv.txt",threshold_inv)
	parser.writeValues3("data/threshold2_inv.txt",threshold_gauss_inv)
	print("Thresholds writed in data/threshold_.txt")
